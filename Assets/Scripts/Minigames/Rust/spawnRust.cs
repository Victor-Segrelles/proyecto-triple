    ...
    void GenerateRust(int cantidad)
    {
        ...
        while (i < cantidad)
        {
            ...
            if (rustHitG.collider != null)
            {
                ...
                //miro si ya hab�a una marca en la barra para evitar que se superpongan, est�n en la misma coord x o est�n demasiado pegadas en la coord y
            ...
            rustPosition = new Vector3(Random.Range(2f, 4f), Random.Range(-2f, 2f), 0f);
            Debug.Log("I");
        }
    }
